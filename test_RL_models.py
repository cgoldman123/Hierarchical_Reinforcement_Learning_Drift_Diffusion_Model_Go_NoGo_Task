...
for field in model_list:
    ...
    jobname = f'GNG-{field}'
    os.system(f"sbatch -J {jobname} -o {stdout_name} -e {stderr_name} {ssub_path} {subject_list} {combined_results_dir} {fit_hierarchical} {field} {use_parfor} {use_ddm}")
    print(f"SUBMITTED JOB [{jobname}]")




# ###python3 test_RL_models.py /media/labs/rsmith/lab-members/cgoldman/go_no_go/DDM/RL_DDM_Millner/RL_DDM_fits/alpha_outcome_zeta 1 1
