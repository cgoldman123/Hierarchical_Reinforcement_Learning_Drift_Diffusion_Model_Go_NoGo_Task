...
models = [
    ...
    {'field': 'alpha,outcome_sensitivity,zeta,beta', 'drift_mapping': '', 'bias_mapping': '', 'thresh_mapping': ''},
...
for index, model in enumerate(models, start=1):
    ...
    for simfit_index, simfit_model in enumerate(models, start=1):
        ...
        simfit_thresh_mapping = simfit_model['thresh_mapping']
        simfit_field = simfit_model['field']
...
## RL
# python3 /media/labs/rsmith/lab-members/cgoldman/go_no_go/DDM/RL_DDM_Millner/RL_DDM_CMG-hierarchichal/run_RL_DDM_test_multiple_models.py /media/labs/rsmith/lab-members/cgoldman/go_no_go/DDM/RL_DDM_Millner/RL_DDM_fits/RL_model_identifiability_hierarchical 1 0 0
# joblist | grep GNG | grep -Po 13..... | xargs -n1 scancel